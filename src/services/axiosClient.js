...
//const BASE_URL = "https://api-prod.hpay.cash/api";
...
const BASE_URL_SOCHITEL_TEST = 'https://api.hpaytest.cash/sochitel/'; //'https://wt2.westsofts.com/sochitel/'
//    'https://api.hpaytest.cash/sochitel/';
