...
export default function CashInItem({ id, montant, total, devise, urlPhoto, nom, prenom, frais, telephone, date, heure }: PropType) {
   ...
   return (
        ...
        <View style={{ flexDirection: 'row', marginTop: 25, padding: 5, paddingBottom: 10, borderBottomColor: Colors.gray, /*borderBottomWidth: index + 1 === size ? 0 : 0.4 */}}>
            ...
            <View style={{ flex: 5, alignItems: 'flex-start', justifyContent: 'flex-start', marginLeft: 25 }}>
                <Text style={{ lineHeight: 15, fontWeight: 'bold', fontSize: 16, color: Colors.text }}>{t('transaction.cashin')}</Text>
            ...
            <View style={{ flex: 3, alignItems: 'flex-end' }}>
                <Text style={{ lineHeight: 20, fontSize: 14, color: 'green' }}> + {Number(total).toFixed(2)} {devise} </Text>
            </View>
