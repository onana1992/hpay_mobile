...
import {  getCashOutHistory } from '../../services/request';
...
function CashOutHistory () {
    ...
    React.useEffect(() => {
        fetchCashOut(/*user?.client?.id*/ '3', '', 'desc', page, size, null, null);
    }, []);
    ...
    const fetchMore = () => {
        setPage((prev) => prev + 1);
        fetchCashOut(/*user?.client?.id*/ '3', '', 'desc', page + 1, size, null, null);
    };
