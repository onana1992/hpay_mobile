...
function HpayStoreHistory() {
    ...
    React.useEffect(() => {
        fetchPurchaseHistory('3', '', 'desc', page, size, null, null);
    }, []);
    ...
    const fetchPurchaseHistory = (
        ...
        getPurchaseHistory(
            ...
            newContent.forEach(item => {
                ...
                const date = formatDate(item.dateEff);
                const heure = formatHeure(item.dateEff);
    ...
    const fetchMore = () => {
        setPage((prev) => prev + 1);
        fetchPurchaseHistory('3', '', 'desc', page + 1, size, null, null);
    };
...
export default HpayStoreHistory;
